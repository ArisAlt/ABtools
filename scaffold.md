<!-- ABtools/scaffold.md - v2.36 - 2026-09-05 -->
...
- `tests/test_organiser_resolution.py` (38 tests) pins how a book's identity is resolved: the author guard against rip debris, self-describing folder names, album-vs-track titles, and end-to-end parity between the two organisers starting from files on disk.
...
| restructure | 5.7 | `restructure_for_audiobookshelf.py` |
